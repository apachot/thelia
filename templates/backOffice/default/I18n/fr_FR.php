...
return array(
    ...
    'Countries' => 'Pays',
    'Countries that have the same tax rule' => 'Pays qui ont les mêmes règles de taxe',
    'Country' => 'Pays',
    ...
    'Do you really want to remove the product from this category ?' => 'Êtes-vous sûr de vouloir enlever le produit de cette rubrique',
    'Do you really want to remove this accessory from the product ?' => 'Êtes-vous sûr de vouloir supprimer cet accessoire ?',
    ...
    'Do you really want to remove this attribute from the template ?' => 'Êtes-vous sûr de vouloir retirer cette déclinaison de ce template',
    ...
    'Do you really want to remove this related content from the product ?' => 'Êtes-vous sûr de vouloir supprimer ce contenu associé ?',
    'Do you really want to remove this zone ?' => 'Voulez-vous vraiment supprimer cette zone ?',
    'Do you really want to set this coupon available to everyone ?' => 'Êtes-vous sûr de vouloir rendre ce code promo disponible à tout le monde ?',
    ...
    'Enter here the category name in the default language (%title)' => 'Entrez ici le nom de la rubrique dans la langue par défaut (%title)',
    'Enter here the content name in the default language (%title)' => 'Entrez ici le nom du contenu dans la langue par défaut (%title)',
    'Enter here the currency name in the default language (%title)' => 'Renseignez le nom de la devise dans la langue par défaut (%title)',
    'Enter here the feature name in the default language (%title)' => 'Renseignez le nom de la caractéristique dans la langue par défaut (%title)',
    ...
    'Search' => 'Recherche',
    'Select a category and click (+) to add it to the additional category list' => 'Sélectionnez une rubrique et cliquez sur (+) pour la rajouter dans la liste des rubrique associées',
    ...
    'Select a content and click (+) to add it to this product' => 'Sélectionnez un contenu et cliquez sur (+) pour l\'associer au produit',
    ...
    'Select a product and click (+) to add it as an accessory' => 'Sélectionnez un produit et cliquez sur (+) pour l\'ajouter en tant qu\'accessoire',
